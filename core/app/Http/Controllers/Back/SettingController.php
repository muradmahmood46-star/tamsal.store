...
$input['is_checkout_notice'] = $request->is_checkout_notice;
        $input['checkout_notice_title'] = $request->checkout_notice_title;
        $input['checkout_notice_en'] = $request->checkout_notice_en;
        $input['checkout_notice_ur'] = $request->checkout_notice_ur;
