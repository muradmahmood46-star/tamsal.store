                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <span class="switch-body"></span>
                                                            <span class="switch-text">{{ __('4 Column Banner First') }}</span>
                                                            </label>
                                                        </div>
...
<div class="card mb-4">
    <div class="card-header">
        <h4 class="card-title">{{ __('Checkout Notification Settings') }}</h4>
    </div>
    <div class="card-body">
        <div class="form-group">
            <label for="is_checkout_notice">{{ __('Show Checkout Notification') }}</label>
            <select name="is_checkout_notice" id="is_checkout_notice" class="form-control">
                <option value="1" {{ $extra_settings->is_checkout_notice == 1 ? 'selected' : '' }}>{{ __('Enable') }}</option>
                <option value="0" {{ $extra_settings->is_checkout_notice == 0 ? 'selected' : '' }}>{{ __('Disable') }}</option>
            </select>
        </div>

        <div class="form-group">
            <label for="checkout_notice_title">{{ __('Notification Title') }}</label>
            <input type="text" name="checkout_notice_title" class="form-control" id="checkout_notice_title" value="{{ $extra_settings->checkout_notice_title }}">
        </div>

        <div class="form-group">
            <label for="checkout_notice_en">{{ __('Notification Text (English)') }}</label>
            <textarea name="checkout_notice_en" class="form-control" id="checkout_notice_en" rows="3">{{ $extra_settings->checkout_notice_en }}</textarea>
        </div>

        <div class="form-group">
            <label for="checkout_notice_ur">{{ __('Notification Text (Urdu)') }}</label>
            <textarea name="checkout_notice_ur" class="form-control" id="checkout_notice_ur" rows="3" style="direction: rtl;">{{ $extra_settings->checkout_notice_ur }}</textarea>
        </div>
    </div>
</div>
