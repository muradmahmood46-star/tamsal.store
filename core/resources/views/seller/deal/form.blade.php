    ...
    <div class="card shadow"><div class="card-body">
        ...
        <form method="post" action="{{ $deal ? route('seller.deal.update', $deal->id) : route('seller.deal.store') }}">
            ...
            <div class="row"><div class="col-lg-7">
                ...
                <div class="form-group"><label><strong>{{ __('Select Products From Your Store') }} *</strong> <small class="text-danger" id="min-products-warning" style="display:none">{{ __('(min. 2 required)') }}</small></label><div class="border rounded p-2" style="max-height:420px;overflow:auto">
