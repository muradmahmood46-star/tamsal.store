    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between">
                <h3 class="mb-0 text-dark"><b>{{ __('Create Child Category') }}</b></h3>
			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body">
					<div class="row justify-content-center">
						<div class="col-lg-12">
							<form class="admin-form" action="{{ route('seller.childcategory.store') }}" method="POST">
                                @csrf
								...
								<div class="form-group">
									...
									<input type="text" name="name" class="form-control item-name" id="name" placeholder="{{ __('Enter Childcategory Name') }}" value="{{ old('name') }}" required>
								</div>
