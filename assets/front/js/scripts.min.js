jQuery(document).ready(function (a) {
    ...
    if (void 0 !== i && null !== i) {
        ...
        noUiSlider.create(i, {
            ...
            var c = a[b];
            if (b) {
                if (p) p.innerHTML = Math.round(c);
                if (r) r.value = Math.round(c);
                var mp = document.querySelector(".max_price");
                if (mp && mp !== p) mp.innerHTML = Math.round(c);
                var manMax = document.querySelector("#manual_max_price");
                if (manMax && !manMax.matches(':focus')) manMax.value = Math.round(c);
            } else {
                if (o) o.innerHTML = Math.round(c);
                if (q) q.value = Math.round(c);
                var minP = document.querySelector(".min_price");
                if (minP && minP !== o) minP.innerHTML = Math.round(c);
                var manMin = document.querySelector("#manual_min_price");
                if (manMin && !manMin.matches(':focus')) manMin.value = Math.round(c);
            }
        })
    }
